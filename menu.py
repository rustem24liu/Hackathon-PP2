...
def animate_screen():
    for i in range(0, 30):
        ...
        pygame.display.flip()
        pygame.time.wait(10)
        screen.blit(mainmenu_img, (random.randint(-10, 10), random.randint(-10, 10)))
        pygame.display.flip()
        pygame.time.wait(10)
...
pygame.mixer.music.load('./game_sound/this-is-war-loopable-95413.mp3')
pygame.mixer.music.play(-1)
explosion_sound = pygame.mixer.Sound('./game_sound/explosions/game_sounds_explosions_explosion1.wav')
